        ...
        <Row className="mt-5">
            <Col lg={8} className="mx-auto">
                <div className="customer-reviews bg-white p-4 rounded">
                    ...
                    <div className="d-flex mb-4">
                        <div className="rating-summary text-center me-5">
                            <div className="rating-average display-4">{product.total_rating_score}</div>
                            <div
                                className="rating-stars mb-2">{renderStars(product.total_rating_score / product.total_vote_count)}</div>
                            <div className="rating-count text-muted">({product.total_vote_count} đánh giá)</div>
                        </div>
                        <div className="rating-bars flex-grow-1">
                            {[5, 4, 3, 2, 1].map((stars) => (
                                <div key={stars} className="d-flex align-items-center mb-2">
