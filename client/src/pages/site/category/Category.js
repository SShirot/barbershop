...
const CategorySkeleton = React.lazy(() =>
  import("../../components/loading/CategorySkeleton")
);
const ProductSkeleton = React.lazy(() =>
          ...
          <div className="rating-filter">
            {[5, 4, 3, 2, 1].map((rating) => (
              <Button
                ...
                size={"sm"}
                variant={
                  ratingFilter === rating ? "primary" : "outline-primary"
                }
            ...
            <div className="label-filter mb-4">
              {labels.map((label) => (
                <Button
                  ...
                  size="sm"
                  variant={
                    selectedLabel === label.id ? "primary" : "outline-primary"
                  }
              ...
              : products.map((product, idx) => (
                  <Col md={3} key={idx} className={"item-prod"}>
                    <Card className="mb-4 card-prod">
                      ...
                      <Button
                        variant={
                          product.status === "published" ? "success" : "danger"
                        }
                      >
