...
const DashboardVoteProduct = React.lazy(() =>
  import("../../components/vote/DashboardVoteProduct")
);
...
const ProductDetail = () => {
  ...
  const handleAddToCart = () => {
    // Lấy dữ liệu giỏ hàng hiện tại từ localStorage hoặc Redux
    ...
    // Cập nhật lại số lượng tổng sản phẩm trong giỏ hàng
    ...
    dispatch(setAllCart(cart.items));
  };
          ...
          <div className="product-info">
            ...
            <h1 className="product-title">
              ...
              {product.status !== "published" && (
                <span className="text-danger fs-6">(Đã hết hàng)</span>
              )}
            </h1>
            <div className="d-flex align-items-center mb-2">
              <div className="rating me-2">
                {product.total_rating_score > 0
                  ? renderStarsItem(
                      product.total_rating_score / product.total_vote_count
                    )
                  : renderStarsItem(0)}
                <span className="rating-count ms-1">
                  ({product.total_rating_score})
                </span>
              </div>
            ...
            <div className="product-price mb-3">
              {product.sale ? (
                <>
                  ...
                  <span className="discount-percent ms-2">
                    -{product.sale}%
                  </span>
                </>
              ) : (
            ...
            <div className="delivery-info mb-3">
              ...
              <div className="d-flex align-items-center">
                ...
                <div>
                  <div>
                    <Badge bg="danger">Giao siêu tốc 2h</Badge>
                  </div>
                  <div>
                    Trước 10h ngày mai:{" "}
                    <span className="text-success">Miễn phí</span> 25.000đ
                  </div>
                </div>
              </div>
            </div>
